...
assert(/stop_compare INT; exit 130/.test(wrapper) && /stop_compare TERM; exit 143/.test(wrapper), 'INT and TERM stop compare and still exit with their usual statuses')
